...
<head>
  ...
  <title>Apotik 123 Indonesia | Log in</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?php echo base_url('asetku/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css') ; ?>">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Login </b>APOTIK</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
      ...
      <p class="login-box-msg">Sign in to start your session</p>
       ...
       <form id="frm_login" role="form" action="<?php echo base_url(); ?>auth/login" method="POST">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="username" name="username" autocomplete="false">
        ...
        <div class="row">
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-primary btn-block btn-flat float-righ ">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
