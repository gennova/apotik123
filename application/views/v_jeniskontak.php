              ...
              <table id="example1" class="table table-bordered table-striped table-hover" style="line-height: 1px">
                ...
                <tbody>
                  ...
                  foreach ($suppliers as $key) {
                    echo "<tr><td>".$key->nosupplier."</td><td>".$key->namasupplier."</td><td>".$key->email."</td><td>".$key->telpon."</td><td>".$key->alamat."</td><td>".$key->namasales."</td><td>".$key->telponsales."</td><td>Rp. ".$key->keterangan."</td><td><a href='".base_url('supplier/delete/').$key->id."' id='btn_delete' onclick='data()'><font color='RED'>DELETE</font></a>  <a href='".base_url('supplier/update/').$key->id."'>UPDATE</a></td></tr>";
                  }
                  ?>
                </tbody>
              </table>
