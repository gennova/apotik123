              ...
              <table id="example1" class="table table-bordered table-striped table-hover" style="line-height: 1px">
                ...
                <tbody>
                  ...
                  foreach ($transaksis as $key) {                  	
                    echo "<tr><td>".$i."</td><td>".$key->kodetransaksi."</td><td>".$key->pelanggan."</td><td>".$key->carabayar."</td><td>".$key->tipedo."</td><td>Rp. ".number_format($key->totalharga)."</td><td>".$key->nama."</td><td>".$key->keterangan."</td><td><a href='".base_url('transaksi/detail/').$key->id."'>LIHAT DETAIL</a></td></tr>";
                    $i++;
                  }
                  ?>
                </tbody>
