      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <?php echo form_open('golmargin/insert'); ?>
            <!-- Form Element sizes -->
            <div class="card card-success">
              ...
              <div class="card-body" style="padding: 0.25rem"> 
                <div class="row">                        
                 <div class="col-12">
                  Nama Golongan Margin<input class="form-control form-control-sm" type="text"name="namagolongan" id="namagolongan" placeholder="Nama Golongan" autocomplete="off" required>
                </div>                 
                </div> 
                  <div class="row">
                    <div class="col-4">
                  Margin Resep<input class="form-control form-control-sm" type="text" name="marginresep" placeholder="Margin Resep" id="marginresep" required="">
                 </div>
                  <div class="col-4">
                    Margin Non Resep <input class="form-control form-control-sm" type="text" name="marginnonresep" placeholder="Margin Non Resep" id="marginnonresep">
                  </div>
                  <div class="col-4">
